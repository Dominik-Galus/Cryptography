...
class TestAES:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("He stepped gingerly onto the bridge knowing that enchantment awaited on the other side.", 192),
            ...
            ("When confronted with a rotary dial phone the teenager was perplexed.", 256),
            ("Dont mess with my family or there will be consequences", 192),
            ("Gary didn't understand why Doug went upstairs to get one dollar bills when he invited him to go cow tipping.", 256),
        ],
    )
