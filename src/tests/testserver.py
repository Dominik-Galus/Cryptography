...
class TestServer:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("RSA", 1024, "AES", 192, "1", None, "Despite what your teacher may have told you, there is a wrong way to wield a lasso"),
            ("RSA", 2048, "AES", 256, None, None, "The snow-covered path was no help in finding his way out of the back-country"),
        ],
    )
    def test_server(self, asymmetric_type, asymmetric_key_length, symmetric_type, symmetric_key_length, file_index1, file_index2, message):
        server1 = Server(
        ...
        encrypted = session_server1.encrypt_data(message)
